...
HD_PWD=C:/Users/marse/Documents/digit/project_7_1/project_7_1.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log sevenseg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sevenseg.tcl
