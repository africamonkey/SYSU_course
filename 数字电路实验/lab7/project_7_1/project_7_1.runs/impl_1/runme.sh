...
HD_PWD=C:/Users/marse/Documents/digit/project_7_1/project_7_1.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log sevenseg.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sevenseg.tcl -notrace
